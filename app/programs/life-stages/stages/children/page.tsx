...
function Child() {
    return (
        <GuestLayout>
            <PageHeader
                title={<>Childhood: eating <span className="font-accent">healthily</span></>}
            ...
            <SectionCard className="bg-white py-12 sm:py-16">
                <div className="prose-vitaway mx-auto max-w-[800px] px-5 lg:px-12">
                    <h2 className="text-[#003E48]">Strong bones</h2>
                    <p>
                    ...
                    <h2 className="text-[#003E48]">Sugar</h2>
                    <p>
                    ...
                    <h2 className="text-[#003E48]">Salt</h2>
                    <p>
                    ...
                    <h2 className="text-[#003E48]">Fish</h2>
                    <p>
                    ...
                    <h2 className="text-[#003E48]">Healthy lunches for older kids</h2>
                    <p>
