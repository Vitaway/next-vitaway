            ...
            <div className="col-lg-8">
              <div className="main-contents">
                <div className="font-merri font-normal text-gray-900">
                  ...
                  <p className='my-8'>Alcohol contains lots of calories, however the amount of calories an alcoholic drink contains depends on the type of alcohol, the amount served and what mixers are added. As an example, 1 pint of lager or a 175ml glass of wine contains around 135 calories while a 25ml shot of spirit contains around 56 calories.</p>
                  <p className='my-8'>To minimise the health risks associated with drinking alcohol, consumption should be limited to no more than 14 units per week for men and women. One unit is the same as one small single measure of spirits, while a 175ml glass of wine or a pint of standard strength lager or cider contains 2 units.</p>

                  <h2 className='text-2xl font-semibold mt-5'>Dehydration</h2>
                  <p className='my-8'>We get dehydrated when we don’t drink enough fluid. One of the first signs of dehydration is feeling thirsty but you may notice other signs:</p>
                  ...
                  <p className='my-8'>Talk to your doctor if you have concerns about any of these symptoms.</p>
                </div>
              </div>
            </div>
          </div>
