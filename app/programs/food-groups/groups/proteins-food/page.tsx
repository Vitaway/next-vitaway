...
function Proteins() {
  return (
    <GuestLayout>
      <PageHeader
        title={<>Protein <span className="font-accent">foods</span></>}
      ...
      <SectionCard className="bg-white py-12 sm:py-16">
        <div className="prose-vitaway mx-auto max-w-[800px] px-5 lg:px-12">
          ...
          <ol className="mt-3 list-decimal space-y-1 pl-5 text-[#003E48]/70">
          ...
          <div className="mt-6 overflow-x-auto">
            <table className="w-full text-left">
              <thead>
                <tr>
                  <th className={thClass} colSpan={3}>Daily Recommendations*
                  </th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <th className={thClass}><strong>Toddlers</strong></th>
                  <td className={tdClass}>12 to 23 months</td>
                  <td className={tdClass}>½ to 1 cup</td>
                </tr>
                <tr>
                  <th className={thClass} rowSpan={2}>
                    <strong>Children</strong>
                  </th>
                  <td className={tdClass}>2-4 yrs</td>
                  <td className={tdClass}>1 to 1½ cups</td>
                </tr>
                <tr>
                  <td className={tdClass}>5-8 yrs</td>
                  <td className={tdClass}>1 to 2 cups</td>
                </tr>
                <tr>
                  <th className={thClass} rowSpan={2}><strong>Girls</strong>
                  </th>
                ...
                <tr>
                  <th className={thClass} rowSpan={2}><strong>Boys</strong>
                  </th>
                  <td className={tdClass}>9-13 yrs</td>
                  <td className={tdClass}>1½ to 2 cups</td>
                </tr>
                ...
                <tr>
                  <th className={thClass} rowSpan={3}><strong>Women</strong>
                  </th>
                ...
                <tr>
                  <th className={thClass} rowSpan={3}><strong>Men</strong>
                  </th>
                  <td className={tdClass}>19-30 yrs</td>
                  <td className={tdClass}>2 to 2½ cups</td>
                </tr>
          ...
          <blockquote className="mt-6 border-l-2 border-[#5CE0C6] pl-4 text-[#003E48]/70">
          ...
          <h2 className="text-[#003E48]">Nutrients of  protein group</h2>
          <ul>
