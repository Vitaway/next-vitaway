...
function Vegetables() {
  return (
    <GuestLayout>
      <PageHeader
        title={<>Vegetables that actually <span className="font-accent">help</span></>}
      ...
      <SectionCard className="bg-white py-12 sm:py-16">
        <div className="prose-vitaway mx-auto max-w-[800px] px-5 lg:px-12">
          <h2 className="text-[#003E48]">Did you know most Australians eat only about half the recommended quantity of vegetables per day?</h2>
          <p>
          ...
          <h2 className="text-[#003E48]">Eating Regularly</h2>
          <p>
          ...
          <h2 className="text-[#003E48]">Eat with other people not TV</h2>
          <p>
      ...
      <SectionCard className="bg-[#F6F3EE]">
        <div className="flex flex-col overflow-hidden rounded-[24px] lg:flex-row">
          <div className="relative h-80 lg:min-h-[400px] lg:w-1/2 lg:h-auto">
            <Image fill sizes="(min-width: 1024px) 50vw, 100vw" src="https://images.unsplash.com/photo-1572357176061-7c96fd2af22f?auto=format&fit=crop&q=80&w=2835&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Building a Healthy and Balanced Diet" className="object-cover" />
          </div>
          <div className="flex flex-col justify-center bg-white p-8 lg:w-1/2 lg:p-12">
            <h2 className="text-2xl font-bold text-[#003E48] sm:text-4xl">
              Building a Healthy and Balanced Diet
            </h2>
            <h3 className="mt-6 text-lg font-bold text-[#003E48]">Make most of your meal vegetables and fruits – ½ of your plate.</h3>
            ...
            <h3 className="mt-4 text-lg font-bold text-[#003E48]">Go for whole grains – ¼ of your plate</h3>
            <p className="mt-2 leading-relaxed text-[#003E48]/70">
            ...
            <h3 className="mt-4 text-lg font-bold text-[#003E48]">Protein power – ¼ of your plate.</h3>
            <p className="mt-2 leading-relaxed text-[#003E48]/70">
            ...
            <h3 className="mt-4 text-lg font-bold text-[#003E48]">Healthy plant oils – in moderation</h3>
            <p className="mt-2 leading-relaxed text-[#003E48]/70">
            ...
            <h3 className="mt-4 text-lg font-bold text-[#003E48]">Drink water, coffee, or tea.</h3>
            <p className="mt-2 leading-relaxed text-[#003E48]/70">
              Skip sugary drinks, limit milk and dairy products to one to two servings per day,
              and limit juice to a small glass per day.
            </p>
            <h3 className="mt-4 text-lg font-bold text-[#003E48]">Stay active.</h3>
            <p className="mt-2 leading-relaxed text-[#003E48]/70">
      ...
      <SectionCard className="bg-white py-12 sm:py-16">
        <div className="prose-vitaway mx-auto max-w-[800px] px-5 lg:px-12">
          <h2 className="text-[#003E48]">The main message of the Healthy Eating Plate is to focus on diet quality:</h2>
          <ul>
            <li>
          ...
          <h2 className="text-[#003E48]">Healthy Eating: Changing Your Eating Habits</h2>
          <p>
          ...
          <p>This information will help you make useful changes for healthy eating.</p>
          <ul>
          ...
          <h2 className="text-[#003E48]">How can you change your eating habits?</h2>
          <p>
