...
function GrainStarch() {
  return (
    <GuestLayout>
      <PageHeader
        title={<>Grains and <span className="font-accent">starch</span></>}
      ...
      <SectionCard className="bg-white py-12 sm:py-16">
        <div className="prose-vitaway mx-auto max-w-[800px] px-5 lg:px-12">
          ...
          <h2 className="text-[#003E48]">How much should I eat from the Grain ( cereal ) group?</h2>
