...
function Fruit() {
  return (
    <GuestLayout>
      <PageHeader
        title={<>Fruit and <span className="font-accent">vegetables</span></>}
      ...
      <SectionCard className="bg-white py-12 sm:py-16">
        <div className="prose-vitaway mx-auto max-w-[800px] px-5 lg:px-12">
          ...
          <h3 className="mt-8 text-lg font-bold text-[#003E48]">Nutrients</h3>
          <ul>
          ...
          <h3 className="mt-8 text-lg font-bold text-[#003E48]">References</h3>
          <ul>
            <li>
