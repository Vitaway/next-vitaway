                ...
                <div className="max-w-3/5">
                    <div className="section-heading">
                        ...
                        <div className="-mx-4 flex flex-wrap mt-10">
                            <a href="well-guide" className="w-full px-2 md:w-2/3 lg:w-3/6">
                                <div className="animate__animated animate__fadeInUp animate__slow">
                                    <div className="mb-8 rounded-[20px] bg-white p-4 shadow-sm hover:shadow-lg md:px-7 xl:px-10"
                                        style={{ border: '1px solid #e7dfd7' }}>
                                        <div
                                            className="mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-[#3268b9]">
                                        ...
                                        <h4 className="text-md  font-medium text-gray-600">
                                            pages/home.programs-eat-well-title
                                        </h4>
                                        <p className="text-gray-600 font-merri font-semibold leading-6 text-md">
                                            pages/home.programs-eat-well-desc
                                        </p>
                                    </div>
                                </div>
                            </a>

                            <a href="food-group" className="w-full px-2 md:w-2/3 lg:w-3/6">
                                <div className="animate__animated animate__fadeInUp animate__slow">
                                    <div className="mb-8 rounded-[20px] bg-white p-4 shadow-sm hover:shadow-lg md:px-7 xl:px-10"
                                        style={{ border: '1px solid #e7dfd7' }}>
                                        <div
                                        ...
                                        <h4 className="mb-2 text-md  font-medium text-gray-600">
                                            pages/home.programs-food-groups-title
                                        </h4>
                                        <p className="text-gray-600 font-merri font-semibold leading-6 text-md">
                                            pages/home.programs-food-groups-desc
                                        </p>
                                    </div>
                                </div>
                            </a>

                            <a href="life-stages" className="w-full px-2 md:w-2/3 lg:w-3/6">
                                <div className="animate__animated animate__fadeInUp animate__slow">
                                    <div className="mb-8 rounded-[20px] bg-white p-4 shadow-sm hover:shadow-lg md:px-7 xl:px-10"
                                        style={{ border: '1px solid #e7dfd7' }}>
                                        <div
                                        ...
                                        <h4 className="mb-2 text-md  font-medium text-gray-600">
                                            pages/home.programs-life-stage-title
                                        </h4>
                                        <p className="text-gray-600 font-merri font-semibold leading-6 text-md">
                                            pages/home.programs-well-being-desc
                                        </p>
                                    </div>
                                </div>
                            </a>

                            <a href="well-being" className="w-full px-2 md:w-2/3 lg:w-3/6">
                                <div className="animate__animated animate__fadeInUp animate__slow">
                                    <div className="mb-8 rounded-[20px] bg-white p-4 shadow-sm hover:shadow-lg md:px-7 xl:px-10"
                                        style={{ border: '1px solid #e7dfd7' }}>
                                        <div
                                        ...
                                        <h4 className="mb-2 text-md  font-medium text-gray-600">
                                            pages/home.programs-well-being-title
                                        </h4>
                                        <p className="text-gray-600 font-merri font-semibold leading-6 text-md">
                                            pages/home.programs-well-being-desc
                                        </p>
