...
function Navbar() {
    return (<>
        <div className="mb-0 py-3 px-3 bg-linear-to-b from-[#003E48] to-[#282e33] text-cente flex items-center justify-center">
            ...
            <p className='ml-2 text-sm text-white'>Visit our Offices located at CPR-Unit House, 1 Floor,  KK21 Ave Niboye, Kicukiro, Kigali for more supports.</p>
        </div>
