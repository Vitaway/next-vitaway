...
function Navbar() {
    return (<>
        <div className="mb-0 py-3 px-3 bg-gradient-to-b from-[#272749] to-[#111827] text-cente flex items-center justify-center">
            ...
            <p className='ml-2 text-sm'>Visit our Offices located at KG 165 St 7, Kimironko, Near the Former KIE &quot;Remera Campus.&quot; for more supports.</p>
        </div>
