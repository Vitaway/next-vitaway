...
export const metadata: Metadata = {
  ...
  description: "Get the answers you've been seeking! Dive into our FAQs for quick, concise solutions to common queries. Your knowledge, simplified.",
  keywords: "Vitaway, FAQs, Questions, Answers",
