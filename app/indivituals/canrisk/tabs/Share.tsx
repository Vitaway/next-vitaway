...
function Share({ score, data }: ShareProps) {
    return (
        <section className="rounded-[24px] bg-[#F6F3EE] p-6 text-[#003E48]" id="share" tabIndex={-1}>
            <h2 tabIndex={-1} className='my-3 font-bold'>Share the <span className="font-accent">questionnaire</span></h2>
            ...
            <p className='flex items-center gap-2'>
                ...
                <a className="font-semibold text-[#E85A2E] hover:underline" href="mailto:?subject=CANRISK+the+Canadian+Diabetes+Risk+Questionnaire&amp;body=I+took+an+online+Diabetes+Risk+Questionnaire+to+find+out+if+I+am+at+risk.++If+you+would+like+to+try+the+questionnaire+I+have+included+the+link+in+this+e-mail+for+you.+It+is+from+the+Public+Health+Agency+of+Canada.%0A%0Ahttps%3A%2F%2Fwww.healthycanadians.gc.ca%2Fen%2Fcanrisk">
            ...
            <div className="risk-score-shell">
                <p className='flex items-center gap-2'>
                    ...
                    <a className="font-semibold text-[#E85A2E] hover:underline" href="http://www.facebook.com/sharer.php?u=http://publichealth.gc.ca/canrisk/index-eng.php&amp;title=The+CANRISK+questionnaire" rel="external" >
                ...
                <p className='flex items-center gap-2'>
                    ...
                    <a className="font-semibold text-[#E85A2E] hover:underline" href="http://twitter.com/home?status=http://publichealth.gc.ca/canrisk/index-eng.php&amp;title=The+CANRISK+questionnaire" rel="external" >
                ...
                <p className='flex items-center gap-2'>
                    ...
                    <a className="font-semibold text-[#E85A2E] hover:underline" href="https://healthycanadians.gc.ca/apps/canrisk-standalone/pdf/canrisk-en.pdf" rel="external" id="pdf-anchor">
