...
/** ISO 3166 countries with ITU-T E.164 calling codes (shared codes listed once per country). */
...
export const DEFAULT_COUNTRY_ISO2 = 'RW';

const defaultCountry = COUNTRY_DIAL_CODES.find((c) => c.iso2 === DEFAULT_COUNTRY_ISO2)!;

/** Countries for selects: default country first, then alphabetical by name. */
export const COUNTRY_DIAL_CODE_OPTIONS: CountryDialCode[] = [
    defaultCountry,
    ...COUNTRY_DIAL_CODES.filter((c) => c.iso2 !== DEFAULT_COUNTRY_ISO2).sort((a, b) =>
        a.name.localeCompare(b.name),
    ),
];

export function getCountryByIso2(iso2: string): CountryDialCode | undefined {
